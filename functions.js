...
function calcularDashboardDia() {
    ...
    const lucro = entradasRecebidas - totalCustosProdutos - totalDespesas;
    const margem = entradasRecebidas > 0 ? ((lucro / entradasRecebidas) * 100).toFixed(1) : 0;
    ...
    // Resumo financeiro
    document.getElementById('dashEntradas').textContent = formatarMoeda(entradasRecebidas);
